+ function($) {
    ...
    class Imessage {
        ...
        init() {
            ...
            // Ấn nút gửi chat
            $('[data-toggle="chatsend"]', self.$element).on('click', function(e) {
                e.preventDefault();
